...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        :root { --primary: #e94560; --dark: #16213e; --success: #28a745; --warning: #ffc107; }
...
<body>
    <div class="header">
        ...
        <div class="header-right">
            <span>Bienvenido, <?= htmlspecialchars($_SESSION['admin_user'] ?? 'Admin') ?></span>
            ...
            <table class="recent-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/admin/pedidos/ver/<?= $pedido['id_pedido'] ?>" class="btn-view">
