...
<head>
    ...
    <title>Roll-ON - Cotizador de Cortinas</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .logo span { color: var(--dark); font-size: 0.8rem; font-weight: 400; }
        .nav-links a {
            color: var(--dark);
            text-decoration: none;
        ...
        .form-group label i { color: var(--gray); font-size: 0.9rem; }
        ...
        .result-box h4 { font-size: 0.9rem; opacity: 0.9; margin-bottom: 0.5rem; }
        ...
        .result-box.error .fa-exclamation-triangle { margin-right: 0.5rem; }
        ...
        .btn-success:hover { transform: translateY(-3px); box-shadow: 0 10px 30px rgba(40,167,69,0.3); }
        ...
        .extra-item .info p { color: var(--gray); font-size: 0.85rem; }
...
<body>
    ...
    <section class="hero">
        <h2>Cotizá tus cortinas</h2>
        <p>Elegí la tela, cargá las medidas y obtené tu presupuesto al instante</p>
        <span class="badge"><i class="fas fa-bolt"></i> Cálculo en tiempo real</span>
    </section>
        ...
        <div class="left-column">
            <div class="card">
                ...
                <div class="form-group">
                    <label>
                        <i class="fas fa-scroll"></i> Tela
                    </label>
                    <select id="tela" class="form-control">
                        <option value="">Seleccionar tela...</option>
                        <?php foreach ($telas as $tela): ?>
                        <option value="<?= $tela['id_tela'] ?>" data-ancho-max="<?= $tela['ancho_maximo_tela'] ?>">
                ...
                <div class="dimensions">
                    <div class="form-group">
                        <label>
                            <i class="fas fa-arrows-alt-h"></i> Ancho (m)
                        </label>
                        <input type="number" id="ancho" class="form-control" step="0.01" min="0.1" max="5" placeholder="Ej: 1.50">
                    </div>
                    <div class="form-group">
                        <label>
                            <i class="fas fa-arrows-alt-v"></i> Largo (m)
                        </label>
    ...
    <script>
        ...
        function validarCampo(input, esPositivo = true) {
            ...
            if (isNaN(num) || valor !== num.toString() && valor !== num.toFixed(2)) {
        ...
        ancho.addEventListener('input', handleInput);
        largo.addEventListener('input', handleInput);
        ...
        function calcular() {
            ...
            if (anchoVal === 'Solo números' || anchoVal === 'Mayor a 0') {
            ...
            if (largoVal === 'Solo números' || largoVal === 'Mayor a 0') {
                resultado.className = 'result-box error';
        ...
        btnFinalizar.addEventListener('click', () => {
            const nombre = prompt('Ingresá tu nombre para el presupuesto:');
            if (!nombre) return;
            ...
            btnFinalizar.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Guardando...';

            fetch('/cotizador/crearPedido', {
                method: 'POST',
                body: formData
            })
            .then(r => r.json())
            .then(data => {
                ...
                btnFinalizar.innerHTML = '<i class="fas fa-check-circle"></i> Finalizar Presupuesto';
